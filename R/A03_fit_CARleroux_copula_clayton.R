...
fit_CARleroux_copula_clayton <- function(formula,
                                      data = NULL,
                                      trials,
                                      W,
                                      burnin = 5000,
  ...
  for(j in 1:n_sample){
    ...
    temp1 <- binomialmcarupdateClaytonRW(Wtriplet = W_triplet,
                                         Wbegfin = W_begfin,
                                         nsites = K,
                                         nvar = J,
                                         phi = phi,
    ...
    temp2 <- Claytontau2updateRW(Wtriplet = W_triplet,
                                 Wbegfin = W_begfin,
                                 nsites = K,
                                 nvar = J,
                                 phi = phi,
    ...
    if(!fix_alpha)
    {
      temp4 <- ClaytonalphaupdateRW(Wtriplet = W_triplet,
                                    Wbegfin = W_begfin,
                                    nsites = K, nvar = J,
                                    phi = phi,
                                    denoffset = den_offset,
